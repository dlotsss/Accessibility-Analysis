...
library(randomForest)
set.seed(111)
my.forest = randomForest(Wheelchair.Accessible ~ Vehicle.Type + Status + Vehicle.Model.Year 
                   + Public.Vehicle.Number + ZIP.Code + CompanyGroup
...
my_prediction <- predict(my.forest, vehicles.test, type = "class")
...
view(vehicles.test$Wheelchair.Accessible)
