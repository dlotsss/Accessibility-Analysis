...
svm.model = svm(factor(Wheelchair.Accessible) ~ Vehicle.Model.Year 
                   + Public.Vehicle.Number + ZIP.Code + CompanyGroup
...
```{r}
#sqrt(mean((vehicles.train$WheelchairAccesible - predict_svm)^2))
...
```{r}
predict_svm_test <- predict(model_svm, vehicles.test$WheelchairAccesible) 
